...
trait Preg_Match_All {
    ...
    protected function preg_match_all(string|null $pattern=null, string|null $subject=null, array|null $match_attribute=null, int $flags=PREG_PATTERN_ORDER, int $offset=0): null|bool|int
    {
        if(is_string($flags)){
