...
//            $class_object = '$' . $class_name;
            ...
            $before[] = 'throw new TemplateException(\'Method "' . $function . '" not found in class: ' . $clas_name . '\' . PHP_EOL . \'Available methods:\' . PHP_EOL . implode(PHP_EOL, ' . $uuid_methods . ') . PHP_EOL);';
            $before[] = '}';
            $before[] = '}';
